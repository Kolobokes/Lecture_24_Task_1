...
## Сценарии перехода к форме записи, подлежащие автоматизации тестирования ##
...
## Сценарии заполнения формы записи, подлежащие автоматизации тестирования ##
...
- набор тестовых данных (при наличии);
...
- при появлении новых способов перехода к форме записи или изменении самой формы записи потребуется корректировка тестовых сценариев и самих тестов.
